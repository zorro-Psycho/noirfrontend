...
const Game = () => {
  ...
  useEffect(() => {
    const handleMessage = (event) => {
      const gameId = 4; // Assuming the gameId for Whack-a-Mole is 4
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-green-400 to-blue-500 text-white">
      ...
      <main className="flex flex-col items-center justify-center py-20">
        <h1 className="text-5xl font-bold mb-10">Whack-a-Mole</h1>
        <div className="flex flex-grow">
          <iframe
            src="https://zorro-psycho.github.io/whach_a_mole"
            width="800"
            height="600"
            title="Whack-a-Mole"
