...
const TicTacToe = () => {
  ...
  useEffect(() => {
    const handleMessage = (event) => {
      const gameId = 3; // Update the gameId to match Tic Tac Toe
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-400 to-blue-500 text-white flex flex-col justify-between">
      <Header />
      <main className="flex flex-col items-center justify-center py-20 flex-grow">
        <h1 className="text-5xl font-bold mb-10">Tic Tac Toe Game</h1>
