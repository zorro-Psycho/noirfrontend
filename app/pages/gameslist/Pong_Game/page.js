...
const Game = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-green-400 via-green-600 to-green-800 text-white flex flex-col justify-between">
      ...
      <main className="flex flex-col items-center justify-center flex-grow py-20">
        ...
        <div className="flex flex-grow">
          <iframe
            src="https://zorro-psycho.github.io/Pong_Game/"
            width="900"
            height="700"
            title="2048 Game"
        ...
        <div className="mt-10 text-center">
           <h3 className="text-lg ">
             Challenge yourself in this retro arcade-style Pong game.
           </h3>
         </div>
      </main>
      <Footer />
