...
useEffect(() => {
    ...
    //   if (event.origin !== "/pacman" && event.origin !== "https://test-noir.vercel.app") return;
      ...
      if (
        ...
        console.log("Valid score message received. Submitting score...");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-900 to-gray-800 flex flex-col justify-between">
      <Header />
