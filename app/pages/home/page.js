...
//               </div>
//               <div className="game-card">
//                 <img src="/break.png" alt="Game 5" className="rounded" />
...
>
  Play Now
              ...
              <div className="game-card">
                {/* <img src="/mine.png" alt="MineSweeper" className="rounded" /> */}
                <img src="/mine.png" alt="MineSweeper" className="rounded ml-2" style={{ width: '250px', height: '220px' }} />

                <h3 className="text-2xl mt-6 text-white">Minesweeper</h3>
                <p className="mt-2 text-m font-serif text-gray-400">Challenge your logic and speed by uncovering all safe cells in a grid while avoiding hidden mines!</p>
                <button
  onClick={() => { window.location.href = "https://ngz.netlify.app/pages/gameslist/Minesweeper"; }}
  className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 transition mt-8 mb-10"
>
  Play Now
</button>
              ...
              <div className="game-card">
                <img src="/pong.png" alt="Pong game" className="rounded" />
                

                <h3 className="text-2xl mt-6 text-white">Pong Game</h3>
                <p className="mt-2 text-m font-serif text-gray-400">Challenge yourself in this retro arcade-style Pong game—play now and see how high you can score!</p>
                <button
  onClick={() => { window.location.href = "https://ngz.netlify.app/pages/gameslist/Pong_Game"; }}
  className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 transition mt-8 mb-10"
>
  Play Now
</button>
              ...
              <div className="game-card">
                <img src="pac.jpg" alt="Game 4" className="rounded" />
                <h3 className="text-2xl mt-6 text-white">Pac-Man</h3>
                <p className="mt-2 text-m font-serif text-gray-400">Guide Pac-Man through the maze, devour pellets, and outsmart ghosts in this classic arcade challenge!</p>
                {/* <button className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 transition mt-8 mb-10">Play Now</button> */}
                <button
  onClick={() => { window.location.href = "https://ngz.netlify.app/pages/gameslist/pac_man"; }}
  className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 transition mt-8 mb-10"
>
  Play Now
</button>
              ...
              {/* <div className="game-card">
                <img src="/pac.jpg" alt="Pac_man game" className="rounded" />
