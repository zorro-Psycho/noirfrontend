...
const FAQ = () => {
  ...
  return (
    <>
      ...
      <Header />
      <section
        className="relative bg-scroll text-center bg-cover bg-bottom bg-no-repeat py-10"
        style={{ backgroundImage: 'url(/bg0.jpeg)' }}
      >
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="relative z-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-white">FAQs</h1>
          <p className="text-lg sm:text-2xl text-white mt-4">
            Get answers to your questions about Noir Game Zone
          </p>
        </div>
      </section>

      <section
        className="py-10 sm:py-20 bg-gray-900 text-center text-white"
        style={{
          background:
            "linear-gradient(to bottom, rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 1)), url('/Faq-bg.jpg') no-repeat center center / cover",
        }}
      >
        <h2 className="text-yellow-300 text-3xl sm:text-4xl mb-6 sm:mb-10 font-bold text-center tracking-wide font-serif">
          Frequently Asked Questions
        </h2>
        <div className="text-left max-w-4xl mx-auto space-y-6 sm:space-y-10">
          {/* General */}
          <div
            className="p-4 sm:p-6 rounded-lg shadow-md cursor-pointer transition-all duration-300 ease-in-out"
            style={{
              background:
                "linear-gradient(to bottom, rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 0.85)), url('/Faqgenral.jpg') no-repeat center center / cover",
            }}
            onClick={() => toggleCategory('general')}
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-blue-300 mb-2 sm:mb-4">
              General
            </h3>
              ...
              <div className="space-y-2 sm:space-y-4">
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    1. What is Noir Game Zone?
                  </h4>
                  <p className="text-gray-200">
                    Noir Game Zone is an innovative online gaming platform by The Noir Soul
                    Syndicate that allows users to play a variety of games, earn NFTs, and collect Noir
                    Coin®.
                  </p>
                </div>
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    2. What types of games are available on Noir Game Zone?
                  </h4>
                  <p className="text-gray-200">
                    We offer a wide range of games including action, strategy, simulation, adventure,
                    puzzle, racing, and sports games such as 0 AD, Battle for Wesnoth, Super Tux Kart,
                    Xonotic, and more.
                  </p>
                </div>
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    3. How do I sign up for Noir Game Zone?
                  </h4>
                  <p className="text-gray-200">
                ...
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    4. Is Noir Game Zone free to use?
                  </h4>
                  <p className="text-gray-200">
                    Yes, joining and playing games on Noir Game Zone is free. However, some premium
                    features and in-game items may require Noir Coin®.
                  </p>
                </div>
              </div>
            )}
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 0.85)), url('/Faqgame.jpg') no-repeat center center / cover",
            }}
            onClick={() => toggleCategory('gameplay')}
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-green-300 mb-2 sm:mb-4">
              Gameplay
            </h3>
            {activeCategory === 'gameplay' && (
              <div className="space-y-2 sm:space-y-4">
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    5. How do I start playing a game?
                  </h4>
                  <p className="text-gray-200">
                    After logging in, navigate to the 'Games' section, choose a game you want to play,
                    and click 'Play Now'. Follow the prompts to launch the game.
                  </p>
                </div>
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    6. Can I play games on Noir Game Zone with friends?
                  </h4>
                  <p className="text-gray-200">
                    Yes, many of our games support multiplayer modes. You can invite friends to join
                    your game or connect with new players through the platform.
                  </p>
                </div>
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    7. What are achievements and how do I earn them?
                  </h4>
                  <p className="text-gray-200">
                    Achievements are milestones you can earn by completing specific tasks or reaching
                    certain goals in games. Each game has its own set of achievements with corresponding
                    rewards.
                  </p>
                </div>
              </div>
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 0.85)), url('/Faqnft.jpg') no-repeat center center / cover",
            }}
            onClick={() => toggleCategory('nfts')}
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-red-300 mb-2 sm:mb-4">
              NFTs and Noir Coin®
            </h3>
            {activeCategory === 'nfts' && (
              <div className="space-y-2 sm:space-y-4">
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    8. What are NFTs in Noir Game Zone?
                  </h4>
                  <p className="text-gray-200">
                    NFTs (Non-Fungible Tokens) in Noir Game Zone are unique digital assets that represent
                    ownership of in-game items, achievements, or exclusive content. They can be
                    collected, traded, and sold.
                  </p>
                </div>
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    9. How do I earn Noir Coin®?
                  </h4>
                  <p className="text-gray-200">
                    You can earn Noir Coin® by achieving milestones in games, participating in
                    tournaments, engaging in community activities, and completing special challenges and
                    quests.
                  </p>
                </div>
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    10. How can I use Noir Coin®?
                  </h4>
                  <p className="text-gray-200">
                    Noir Coin® can be used to purchase in-game items, unlock premium features, and
                    exchange for NFTs. It can also be traded with other players.
                  </p>
                </div>
              </div>
            )}
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 0.85)), url('/Faqsupport.jpg') no-repeat center center / cover",
            }}
            onClick={() => toggleCategory('support')}
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-yellow-300 mb-2 sm:mb-4">
              Support
            </h3>
            {activeCategory === 'support' && (
              <div className="space-y-2 sm:space-y-4">
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    11. How do I contact Noir Game Zone support?
                  </h4>
                  <p className="text-gray-200">
                    You can contact our support team by visiting the 'Contact Us' page on our website.
                    Alternatively, you can email us at support@noirgamezone.com.
                  </p>
                </div>
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    12. What should I do if I encounter a problem while playing a game?
                  </h4>
                  <p className="text-gray-200">
                    If you encounter any issues, please report them through the in-game support option or
                    contact our support team for assistance.
                  </p>
                </div>
                <div>
                  <h4 className="text-lg sm:text-2xl font-bold text-yellow-300">
                    13. How do I reset my account password?
                  </h4>
                  <p className="text-gray-200">
                    To reset your password, go to the 'Forgot Password' page on the login screen and
                    follow the instructions. You'll receive an email with a link to reset your password.
                  </p>
                </div>
              </div>
            )}
